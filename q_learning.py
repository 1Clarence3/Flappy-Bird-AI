...
class QLearning:
    ...
    def __init__(self, train):
        ...
        self.alpha_decay = 0.00003  # 20,000 episodes to fully decay                print('test')
    ...
    def load_training_states(self):
        ...
        if self.train:
            ...
            try:
                #with open("data/training_values_test.json", "r") as f:
    ...
    def save_training_states(self):
        if self.train:
            ...
            #with open("data/training_values_test.json", "w") as f:
